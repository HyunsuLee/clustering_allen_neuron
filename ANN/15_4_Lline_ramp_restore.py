...
result_path = './190315_hyperparameter_test/15_2_Lline_ramp_fine.csv'
...
np.savetxt('./revised_results/15_4_Lline_ramp_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_results/Ltest_rampY_argmax.csv', label_argmax, delimiter = ',')
