...
np.savetxt('./revised_notmerged_results/05_4_Eline_long_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_notmerged_results/Etest_longY_argmax.csv', label_argmax, delimiter = ',')
