...
result_path = './190319_hyperparameter_test/05_2_Eline_long_fine.csv'
...
np.savetxt('./revised_normerged_results/05_4_Eline_long_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_normerged_results/Etest_longY_argmax.csv', label_argmax, delimiter = ',')
