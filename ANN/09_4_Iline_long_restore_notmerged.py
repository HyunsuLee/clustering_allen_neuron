...
np.savetxt('./revised_notmerged_results/09_4_Iline_long_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_notmerged_results/Itest_longY_argmax.csv', label_argmax, delimiter = ',')
