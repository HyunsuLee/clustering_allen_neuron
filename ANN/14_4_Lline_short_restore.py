...
result_path = './190315_hyperparameter_test/14_2_Lline_short_fine.csv'
...
np.savetxt('./revised_results/14_4_Lline_short_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_results/Ltest_shortY_argmax.csv', label_argmax, delimiter = ',')
