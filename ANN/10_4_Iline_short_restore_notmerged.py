...
np.savetxt('./revised_normerged_results/10_4_Iline_short_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_normerged_results/Itest_shortY_argmax.csv', label_argmax, delimiter = ',')
