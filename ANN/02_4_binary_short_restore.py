...
result_path = './190315_hyperparameter_test/02_2_binary_short_fine.csv'
...
np.savetxt('./revised_results/02_4_binary_short_ANNmodel_prob.csv', model_prob, delimiter=',')
np.savetxt('./revised_results/Btest_shortY.csv', testY, delimiter = ',')
