...
np.savetxt('./revised_notmerged_results/04_4_Eline_full_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_notmerged_results/EtestY_argmax.csv', label_argmax, delimiter = ',')
