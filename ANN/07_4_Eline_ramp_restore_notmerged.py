...
np.savetxt('./revised_notmerged_results/07_4_Eline_ramp_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_notmerged_results/Etest_rampY_argmax.csv', label_argmax, delimiter = ',')
