...
result_path = './190315_hyperparameter_test/07_2_Eline_ramp_fine.csv'
...
np.savetxt('./revised_results/07_4_Eline_ramp_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_results/Etest_rampY_argmax.csv', label_argmax, delimiter = ',')
