...
np.savetxt('./revised_notmerged_results/08_4_Iline_full_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_notmerged_results/ItestY_argmax.csv', label_argmax, delimiter = ',')
