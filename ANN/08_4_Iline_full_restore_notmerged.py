...
result_path = './190319_hyperparameter_test/08_2_Iline_full_fine.csv'
...
np.savetxt('./revised_normerged_results/08_4_Iline_full_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_normerged_results/ItestY_argmax.csv', label_argmax, delimiter = ',')
