...
result_path = './190315_hyperparameter_test/09_2_Iline_long_fine.csv'
...
np.savetxt('./revised_results/09_4_Iline_long_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_results/Itest_longY_argmax.csv', label_argmax, delimiter = ',')
