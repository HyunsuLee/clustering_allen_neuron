...
result_path = './190319_hyperparameter_test/11_2_Iline_ramp_fine.csv'
...
np.savetxt('./revised_notmerged_results/11_4_Iline_ramp_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_notmerged_results/Itest_rampY_argmax.csv', label_argmax, delimiter = ',')
