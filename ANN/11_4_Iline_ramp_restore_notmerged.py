...
np.savetxt('./revised_normerged_results/11_4_Iline_ramp_argmax.csv', model_argmax, delimiter=',')
np.savetxt('./revised_normerged_results/Itest_rampY_argmax.csv', label_argmax, delimiter = ',')
