...
for(i in 1:12){
  ...
  scale_fill_gradient2(mid = "lightgoldenrodyellow", high = "firebrick2")+geom_text(label=fig7data[[i]]$Freq) + theme(plot.title = element_blank(),
          axis.title = element_blank(),
          axis.text = element_blank(),
          axis.ticks = element_blank(), 
          panel.background = element_blank(), 
...
fig7[[9]] <- fig7[[9]] + scale_y_discrete(limits = rev(levels(fig7data[[i]]$Reference)), labels=rev(Lline_name), position = "left") + labs(y = "RF") + scale_x_discrete(labels=Lline_name, position = "bottom") + theme(axis.title = element_text(size = rel(1.5)), axis.title.x = element_blank(), axis.ticks.x= element_line(), axis.text.x = element_text(hjust=1, vjust = 0.5, angle = 90))

fig7[[10]] <- fig7[[10]] + scale_x_discrete(labels=Lline_name, position = "bottom") + theme(axis.ticks.x= element_line(), axis.text.x = element_text(hjust=1, vjust = 0.5, angle = 90))
fig7[[11]] <- fig7[[11]] + scale_x_discrete(labels=Lline_name, position = "bottom") + theme(axis.ticks.x= element_line(), axis.text.x = element_text(hjust=1, vjust = 0.5, angle = 90))

fig7[[12]] <- fig7[[12]] + scale_x_discrete(labels=Lline_name, position = "bottom") + theme(axis.ticks.x= element_line(), axis.text.x = element_text(hjust=1, vjust = 0.5, angle = 90), axis.ticks.y.right = element_line(), axis.text.y.right = element_text(hjust=0, vjust = 0.5))

fig7_u_grob <-lapply(fig7, ggplotGrob)
fig7_u_grob
fig7_cm <- grid.arrange(grobs = fig7_u_grob, ncol = 4, nrow = 3, heights = c(1,0.9,1.2), widths = c(1, 0.9, 0.9, 1.1))
